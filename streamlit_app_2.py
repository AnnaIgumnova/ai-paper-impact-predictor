...
# Top-level layout — form on the left, results on the right
col_form, col_output = st.columns([1, 1], gap="small")

with col_form:
    with st.form("prediction_form"):
        st.subheader("Enter Paper Metadata")

        # Split inputs into two columns for a cleaner layout
        ...
        with col2:
            st.markdown('**Bibliometric signals**')
            ...
            sdg_4 = st.checkbox("SDG: Quality Education")
